...
function insertDefaultData() {
  ...
  const emergencyContents = [
    { image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=peaceful%20nature%20landscape%20with%20mountains%20and%20lake%20sunset%20calming%20scene&image_size=landscape_16_9', quote: '慢慢来，所有的事情都会好起来的。' },
    { image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=serene%20forest%20path%20with%20sunlight%20filtering%20through%20trees%20peaceful%20scene&image_size=landscape_16_9', quote: '你已经做得很好了，给自己一些休息的时间。' },
    { image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=beautiful%20beach%20with%20clear%20blue%20water%20and%20white%20sand%20calm%20ocean&image_size=landscape_16_9', quote: '内心的平静是最重要的，不要被外界的喧嚣所打扰。' }
  ];
